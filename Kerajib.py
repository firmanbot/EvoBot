...
cl.login(token="EmwS8rywwwDhEXiKzAq9.GvZh4F/QCoURB6kbuQaIwq.6u/nAScWleiPEZnbSJRqkd35E57gfi32XrslXp6/zqo=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="Em0fVYLtqrXcGBJ0d5a0.TNFzgE8VJ4k3jsKgeUaiya.7eRIsxMvZM+GEan/EEHkDNvLLGiiVRdyR6//DgZkpPY=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EmhNMqnwHaYgvJJvTjJ4.uquO+JrPHgVtF+OBQ8yj1a.9u1mwwfzr82gLx/IC55QShpz35rh0kTlx6QcA1cYjQ8=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="Emgxy32S926hJ2yNggcc.PSXsYjQQ1+M9lvEfoTloNa.mWEPA8hce9MO72frYBGm9ojmySVcRppGrOI1OIh/w0o=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="Emzm1n8wbGQErA0EZcE3.PEsDOPBlPlSebpj8h2+CyW.6NtW/tKiiV3jJVn54UN3HZltb2zOHddSbMSduH51urc=")
ks.loginResult()
...
helpMessage ="""Keyword ҉͜͡モ͜͡҉͜V͡҉͜͡の͜͡҉͜͡B͜͡҉͜͡の͜͡҉͜͡T͜͡҉
Creator: ●ƒǐɾɱɑɳ●
‖―――――――――‖―――――――――‖
            Key Untuk Umum  
‖―――――――――‖―――――――――‖
...
admin=["u16baba09004cd8424cd2d0a0a47da7c6","ufbd7e73bc7bb1975a2be69e4f362229c"] 
owner=["u16baba09004cd8424cd2d0a0a47da7c6","ufbd7e73bc7bb1975a2be69e4f362229c"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'autoAdd':True,
    'message':"""Note:
bot ini hanya bisa diundang oleh admin.
oleh karena itu mintalah kepada admin untuk mengundang bot ini.
id: firmansyah_58""",
    "lang":"JP",
        ...
        if op.type == 19: #Member Ke Kick
          ...
          if op.param2 in admin:
            ...
            try:
              ...
              G = ki.getGroup(op.param1) #Sanji Bertindak
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    jawab = ['Ya','Tidak']
                    dsn = random.choice(jawab)
                    cl.sendText(msg.to,jawab)
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                if wait["Protectgr"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Kerjib on","kerjib on"]:
                if wait["Kerajib"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Fitur kerang ajaib aktif")
                    else:
                        cl.sendText(msg.to,"done")
                else:
                    wait["Kerajib"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Kerjib off","kerjib off"]:
                if wait["Kerajib"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Fitur kerang ajaib mati")
                    else:
                        cl.sendText(msg.to,"done")
                else:
                    wait["Kerajib"] = False
              ...
              if msg.from_ in admin:
                ...
                if wait["Kerajib"] == True: md+="[•]kerajib [On]\n"
                else: md+="[•]kerjib [Off]\n"
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
                ...
                cl.sendText(msg.to, "daftar sider telah direset")
                try:
                ...
                #print wait2
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Reset dulu\nBaru Ketik read ♪")
#-----------------------------------------------
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    random.choice(KAC).sendText(msg.to,"Installing...")
                    random.choice(KAC).sendText(msg.to,"Install complete.\nRunning....")
                    random.choice(KAC).sendText(msg.to,"Your Group is infected by Worm.LineKicker.exe")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': mid}
                    random.choice(KAC).sendMessage(msg)
                    targets = []
...
#-----------------------------------------------
      ...
      #-------------Fungsi Balesan Respon Start---------------------#
            ...
            elif msg.text in ["Kerang ajaib"]:
                cl.sendText(msg.to,"Cara menggunakan\n* Ketik 'Apakah/Kapan/Siapakah' setelah kata tersebut bebas, kecuali kata 'siapakah' harus pake nama orang. Contoh:\n> Siapakah Doni?\n> Apakah saya Ganteng? \n> Kapan saya mandi? \n\nDan sebagainya.")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u16baba09004cd8424cd2d0a0a47da7c6'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator Kami")

            elif "Rendang" in msg.text:
              	cl.sendImageWithUrl(msg.to,"http://i66.tinypic.com/jky32c.jpg")

            elif "Read" in msg.text:
              	cl.sendImageWithUrl(msg.to,"http://i65.tinypic.com/syxz60.jpg")
      ...
      #-------------Fungsi Chat ----------------
                ...
                if msg.toType == 2:
                  if wait["Kerajib"] == True:
                    ...
                    cl.sendText(msg.to,dll)
	
            elif ("Siapakah " in msg.text): 
                if msg.toType == 2:
                  if wait["Kerajib"] == True:
...
#---------------------
        if op.type == 17:
          ...
          cl.sendText(op.param1, "Pembuat Grup " + str(ginfo.name) + " :\n" + ginfo.creator.displayName)
          cl.sendText(op.param1,"rules")
          cl.sendText(op.param1,"intro")
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          cl.sendText(op.param1, "Kutu everywhere ")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Awuto laik bay Firman")
          ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Awuto laik bay Firman")
          kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Awuto laik bay Firman")
          kc.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Awuto laik bay Firman")
          ks.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Awuto laik bay Firman")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by Evo bot")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Jangan lupa dilike back.")
                    print "Like"
                except:
                    pass
            else:
